...
W1 = tf.Variable(tf.truncated_normal(shape=[batch_size,exampleNum*timeWindow,lookForwardPeriod],stddev=0.1))
B1 = tf.Variable(tf.constant(0.1, shape=[lookForwardPeriod]))
