...
from keras.layers import Input, Dense, LSTM, TimeDistributed, Dropout, Flatten
...
forecastOutputs = Dense(lookForwardPeriod, activation='linear')(forecasterFlatten)

forecaster = Model(forecastInputs,forecastOutputs)
forecaster.compile(optimizer=Nadam(lr=0.002), loss='mse', metrics=['accuracy'])

print forecaster.input_shape
print forecaster.output_shape
